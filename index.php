...
<body style="background-color : #f4f4f6">
    ...
    <main class="d-flex flex-column">
        <img class="d-flex mx-auto" style="height: 300px " src="images/logo.png" alt="logo">
        ...
        <div class="d-flex mx-auto mt-3">
            <a href="inscription.php" style="text-decoration: none ; color: #000"> Pas encore de compte ? <strong>Inscrivez-vous !</strong></a>
        </div>
    </main>
